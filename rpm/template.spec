...
Name:           ros-jazzy-crazyflie-examples
Version:        1.0.5
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS crazyflie_examples package

License:        MIT
URL:            https://index.ros.org/p/crazyflie_examples/#jazzy
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-crazyflie-py
...
BuildRequires:  ros-jazzy-crazyflie-py
